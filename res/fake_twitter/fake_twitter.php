...
<head>
  ...
  <link href="http://a0.twimg.com/a/1276197224/stylesheets/settings.css?1276316974" media="screen, projection" rel="stylesheet" type="text/css" />
	...
	<style>
	.verweise {border:1px solid red;padding:3px;outline:none;border-color:rgba(255,50,50,.75);box-shadow:0 0 8px rgba(200,50,50,.5);-moz-box-shadow:0 0 8px rgba(200,50,50,.5);-webkit-box-shadow:0 0 8px rgba(200,50,50,.5);}
	</style>
	<script>
...
name="client_application[organization_url]" size="30" type="text">      
    <small><p>The home page of your company or organization.</p></small>
      ...
      <tr id="type_row">
        ...
        <td>
          <div class="verweise"><input id="client_application_desktop_1" 
...
name="client_application[callback_url]" class="verweise" size="30" type="text">          <p><small>Where
...
type:</label></th>
        <td>
         <div class="verweise"> <input checked="checked" id="client_application_is_writable_1" 
